...
if (window.devicePixelRatio) {
    ...
    for (var k = 0; k < canvases.length; ++k) {
        ...
        // XXX assumes that style dimensions are given in pixels
        if (canvas.style.width) width = parseInt(canvas.style.width);
        if (canvas.style.height) height = parseInt(canvas.style.height);

...
you're reading this on a high-DPI device like a smart phone or a newish
Macbook, your screen really doesn't like displaying this kind of pattern and you
might see weird artifacts like a faint grid of polka dots or colorful
flickering. You can try zooming in on your device until such effects disappear.
Also if you are very close to the screen, you might actually be able to see the
individual pixels, which is also not what we want. Adjust your viewing distance
or squint your eyes. The goal is to have this square appear like one uniform
shade of gray.
...
Well let's put those two side-by-side. The checkerboard from above first,
...
ubiquitious standard: sRGB. I fudged things earlier when I was talking about
...
operating system, which uploads it your image editing software, which uploads it
to your graphics card, which uploads it your screen. All of those intermediate

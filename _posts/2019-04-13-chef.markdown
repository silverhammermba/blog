...
was expensive), I noticed a difference in how we talked about our Sunbasket
meals. Rather than saying "This isn't good", we would say "I would've made this
differently". We started noticing certain recipes, or certain steps in recipes,
where we would reliably deviate from the instructions because we knew we liked
it a different way. We would incorporate techniques we saw on Food Wishes into
our Sunbasket meals.
